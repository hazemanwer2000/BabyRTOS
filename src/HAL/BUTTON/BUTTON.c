 ...
 * 
 *************************************************************/
static volatile BUTTON_state_t BUTTON_states[BUTTON_name_Count];
 ...
 * 
 *************************************************************/
static volatile BUTTON_state_t BUTTON_previousStates[BUTTON_name_Count];
 ...
 * 
 *************************************************************/
static volatile uint8_t BUTTON_debouceCounters[BUTTON_name_Count];
